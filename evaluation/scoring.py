...
def score(df_similarity,opt,samples):
	...
	if opt.amplify_filtering.lower()=='yes':
		...
		df_similarity_1['Score']=(df_similarity_1['Similarity_RANK']/2+(df_similarity_1['Richness_COUNT_RANK']+df_similarity_1['Richness_SUM_RANK'])/2).astype(float)
	...
	if opt.amplify_filtering.lower()=='yes':
		...
		#df_similarity_0['Score']=df_similarity_0['Similarity_RANK']+(df_similarity_0['Similarity_RANK_pY1355']+df_similarity_0['Similarity_RANK_pY1361'])/4
		df_similarity_0['Score']=(df_similarity_0['Similarity_RANK']/2+(df_similarity_0['Richness_COUNT_RANK']+df_similarity_0['Richness_SUM_RANK'])/2).astype(float)
	else:
...
def score_tpor(df_similarity,opt,samples):
	...
	df_similarity_1['Score']=(df_similarity_1['Similarity_centralLine_RANK_pY626_mixed'])+df_similarity_1['Similarity_RANK']+(df_similarity_1['Richness_COUNT_RANK']+df_similarity_1['Richness_SUM_RANK'])/2
	...
	df_similarity_0['S1_SUM_RANK']=df_similarity_0['S1_SUM'].rank(ascending=False).astype(float)
	df_similarity_0['S1_COUNT_RANK']=df_similarity_0['S1_COUNT'].rank(ascending=False).astype(float)  
	df_similarity_0['Score']=(df_similarity_0['Similarity_centralLine_RANK_pY626_mixed'])+df_similarity_0['Similarity_RANK']+(df_similarity_0['Richness_COUNT_RANK']+df_similarity_0['Richness_SUM_RANK'])/2
