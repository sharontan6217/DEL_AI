...
<<<<<<< HEAD
		...
		df_similarity_1['Score']=df_similarity_1['Similarity_RANK']+(df_similarity_1['Similarity_RANK_pY1355']+df_similarity_1['Similarity_RANK_pY1361'])/2
		#df_similarity_1['Score']=(df_similarity_1['Similarity_RANK']/2+(df_similarity_1['Richness_COUNT_RANK']+df_similarity_1['Richness_SUM_RANK'])/4).astype(float)
...
>>>>>>> 87ebe5252ee9393e704112a1bb886d2cfacf5196
        ...
        #df_similarity_1['Score']=df_similarity_1['Similarity_RANK']+(df_similarity_1['Richness_COUNT_RANK']+df_similarity_1['Richness_SUM_RANK'])+(df_similarity_1['S1_COUNT_RANK']+df_similarity_1['S1_SUM_RANK'])
		#df_similarity_1['Score']=(df_similarity_1['Similarity_RANK']/2+(df_similarity_1['Similarity_point_RANK_pY1355_mixed']+df_similarity_1['Similarity_point_RANK_pY1361_mixed'])+(df_similarity_1['Richness_COUNT_RANK']+df_similarity_1['Richness_SUM_RANK'])).astype(float)
		#df_similarity_1['Score']=df_similarity_1['Similarity_RANK']/2+(df_similarity_1['Richness_COUNT_RANK']+df_similarity_1['Richness_SUM_RANK'])/2
<<<<<<< HEAD
		df_similarity_1['Score']=df_similarity_1['Similarity_RANK']/2+(df_similarity_1['Similarity_RANK_pY1355']+df_similarity_1['Similarity_RANK_pY1361'])
		#df_similarity_1['Score']=(df_similarity_1['Similarity_RANK']/2+(df_similarity_1['Similarity_RANK_pY1355']+df_similarity_1['Similarity_RANK_pY1361'])+(df_similarity_1['Similarity_point_RANK_pY1355']+df_similarity_1['Similarity_point_RANK_pY1361'])).astype(float)
		#df_similarity_1['Score']=(df_similarity_1['Richness_COUNT_RANK']+df_similarity_1['Richness_SUM_RANK'])/2
=======
		#f_similarity_1['Score']=(df_similarity_1['Richness_COUNT_RANK']+df_similarity_1['Richness_SUM_RANK'])/2
>>>>>>> 87ebe5252ee9393e704112a1bb886d2cfacf5196
        #df_similarity_1['Score']=(df_similarity_1['Similarity_RANK']/2+(df_similarity_1['Similarity_point_RANK_pY1355_mixed']+df_similarity_1['Similarity_point_RANK_pY1361_mixed'])+(df_similarity_1['Richness_COUNT_RANK']+df_similarity_1['Richness_SUM_RANK'])).astype(float)     
...
>>>>>>> 87ebe5252ee9393e704112a1bb886d2cfacf5196
	...
	for i in range(len(df_similarity_1)):
		...
		if opt.amplify_filtering.lower()=='yes':
			...
			if weight==5:
				df_similarity_1 ['Score'].values[i] = df_similarity_1 ['Score'].values[i]/168
			elif weight==4:
...
<<<<<<< HEAD
		...
		#df_similarity_0['Score']=(df_similarity_0['Similarity_RANK']+(df_similarity_0['Similarity_antiinsr_RANK_pY1355']+df_similarity_0['Similarity_antiinsr_RANK_pY1361'])+(df_similarity_0['Richness_COUNT_RANK']+df_similarity_0['Richness_SUM_RANK'])).astype(float)
		df_similarity_0['Score']=df_similarity_0['Similarity_RANK']+(df_similarity_0['Similarity_RANK_pY1355']+df_similarity_0['Similarity_RANK_pY1361'])/2
		#df_similarity_0['Score']=(df_similarity_0['Similarity_RANK']/2+(df_similarity_0['Richness_COUNT_RANK']+df_similarity_0['Richness_SUM_RANK'])/4).astype(float)
	else:
		...
		#df_similarity_0['Score']=((df_similarity_0['Similarity_centralLine_RANK_pY1355']+df_similarity_0['Similarity_centralLine_RANK_pY1361'])+(df_similarity_0['Similarity_RANK_pY1361']+df_similarity_0['Similarity_RANK_pY1355'])).astype(float)
		...
		df_similarity_0['Score']=df_similarity_0['Similarity_RANK']/2+(df_similarity_0['Similarity_RANK_pY1355']+df_similarity_0['Similarity_RANK_pY1361'])
		...
		#df_similarity_0['Score']=(df_similarity_0['Similarity_RANK']/2+(df_similarity_0['Similarity_RANK_pY1355']+df_similarity_0['Similarity_RANK_pY1361'])+(df_similarity_0['Similarity_point_RANK_pY1355']+df_similarity_0['Similarity_point_RANK_pY1361'])).astype(float)
=======
		df_similarity_0['Score']=(df_similarity_0['Similarity_RANK']+(df_similarity_0['Similarity_antiinsr_RANK_pY1355']+df_similarity_0['Similarity_antiinsr_RANK_pY1361'])+(df_similarity_0['Richness_COUNT_RANK']+df_similarity_0['Richness_SUM_RANK'])).astype(float)
		#df_similarity_0['Score']=(df_similarity_0['Similarity_RANK']+(df_similarity_0['Similarity_point_RANK_pY1355']+df_similarity_0['Similarity_centralLine_RANK_pY1361'])/2+(df_similarity_0['Richness_COUNT_RANK']+df_similarity_0['Richness_SUM_RANK'])).astype(float)
	else:
		#df_similarity_0['Score']=((df_similarity_0['Similarity_centralLine_RANK_pY1355']+df_similarity_0['Similarity_centralLine_RANK_pY1361'])+(df_similarity_0['Similarity_RANK_pY1361']+df_similarity_0['Similarity_RANK_pY1355'])).astype(float)
		#df_similarity_0['Score']=(df_similarity_0['Similarity_RANK']/2+(df_similarity_0['Similarity_point_RANK_pY1355_mixed']+df_similarity_0['Similarity_point_RANK_pY1361_mixed'])+(df_similarity_0['Richness_COUNT_RANK']+df_similarity_0['Richness_SUM_RANK'])).astype(float)
		#df_similarity_0['Score']=df_similarity_0['Similarity_RANK']/2+(df_similarity_0['Richness_COUNT_RANK']+df_similarity_0['Richness_SUM_RANK'])/2
...
<<<<<<< HEAD
	...
	for i in range(len(df_similarity_0)):
		...
		if opt.amplify_filtering.lower()=='yes':
			...
			if weight==5:
				df_similarity_0 ['Score'].values[i] = df_similarity_0 ['Score'].values[i]/168
			elif weight==4:
...
def score_tpor(df_similarity,opt,samples):
	...
	df_similarity_1 = df_similarity[df_similarity['class']==1]
	df_similarity_1= df_similarity_1.sort_values(by =['Similarity'],ascending=True)
	df_similarity_1['Similarity_antitpor_RANK_pY626']=df_similarity_1['Similarity_antitpor_626'].rank(ascending=True).astype(float)

	df_similarity_1['Similarity_RANK_pY626']=df_similarity_1['Similarity_pY626'].rank(ascending=True).astype(float)

	df_similarity_1['Similarity_centralLine_RANK_pY626']=df_similarity_1['Similarity_centralLine_pY626'].rank(ascending=True).astype(float)

	df_similarity_1['Similarity_point_RANK_pY626']=df_similarity_1['Similarity_point_pY626'].rank(ascending=True).astype(float)

	df_similarity_1['Similarity_point_RANK_pY626_mixed']=df_similarity_1['Similarity_point_pY626_mixed'].rank(ascending=True).astype(float)

	df_similarity_1['S1_Richness_efficiency_RANK']=df_similarity_1['S1_Richness_efficiency'].rank(ascending=False).astype(float)
	df_similarity_1['S1_Richness_balance_RANK']=df_similarity_1['S1_Richness_balance'].rank(ascending=False).astype(float)
	df_similarity_1['Similarity_centralLine_RANK_pY626_mixed']=df_similarity_1['Similarity_centralLine_pY626_mixed_ipca'].rank(ascending=True).astype(float)
	...
	df_similarity_1['Score']=(df_similarity_1['Similarity_centralLine_RANK_pY626_mixed'])+df_similarity_1['Similarity_RANK']+(df_similarity_1['Richness_COUNT_RANK']+df_similarity_1['Richness_SUM_RANK'])
	...
	df_similarity_0 = df_similarity[df_similarity['class']==0]
	df_similarity_0= df_similarity_0.sort_values(by =['Similarity'],ascending=True)
	df_similarity_0['Similarity_RANK_pY626']=df_similarity_0['Similarity_pY626'].rank(ascending=True).astype(float)
	df_similarity_0['Similarity_RANK_pY626']=df_similarity_0['Similarity_pY626'].rank(ascending=True).astype(float)

	df_similarity_0['Similarity_centralLine_RANK_pY626']=df_similarity_0['Similarity_centralLine_pY626'].rank(ascending=True).astype(float)        

	df_similarity_0['Similarity_point_RANK_pY626']=df_similarity_0['Similarity_point_pY626'].rank(ascending=True).astype(float)

	df_similarity_0['Similarity_point_RANK_pY626_mixed']=df_similarity_0['Similarity_point_pY626_mixed'].rank(ascending=True).astype(float)

	df_similarity_0['Similarity_antitpor_RANK_pY626']=df_similarity_0['Similarity_antitpor_626'].rank(ascending=True).astype(float)

	df_similarity_0['S1_Richness_efficiency_RANK']=df_similarity_0['S1_Richness_efficiency'].rank(ascending=False).astype(float)
	df_similarity_0['S1_Richness_balance_RANK']=df_similarity_0['S1_Richness_balance'].rank(ascending=False).astype(float)
	df_similarity_0['Similarity_centralLine_RANK_pY626_mixed']=df_similarity_0['Similarity_centralLine_pY626_mixed_ipca'].rank(ascending=True).astype(float)        
	...
	df_similarity_0['S1_SUM_RANK']=df_similarity_0['S1_SUM'].rank(ascending=False).astype(float)
	df_similarity_0['S1_COUNT_RANK']=df_similarity_0['S1_COUNT'].rank(ascending=False).astype(float)  
	df_similarity_0['Score']=(df_similarity_0['Similarity_centralLine_RANK_pY626_mixed'])+df_similarity_0['Similarity_RANK']+(df_similarity_0['Richness_COUNT_RANK']+df_similarity_0['Richness_SUM_RANK'])  
...
def score_tpor(df_similarity,opt,samples):
	...
	if opt.amplify_filtering.lower()=='yes':
		...
		phase='phase1'
>>>>>>> 87ebe5252ee9393e704112a1bb886d2cfacf5196
	df_sample.to_csv('sample_finalScore'+'_tpor'+'_'+opt.level+'.csv')
	result_name = 'output_'+opt.model_name+'_'+phase+'_'+opt.level+'.csv'
	df_score.to_csv(opt.output_dir+result_name)
