...
class preprocess():
    def dataNormalize(df):
        ...
        #df_normalized  = pd.DataFrame(Normalizer().fit_transform(data.values),columns=data.columns,index=data.index)
        #df = df.drop(['S1_COUNT','Richness_COUNT','S1_STDEV','Richness_STDEV'],axis=1)
        
        print(df.columns)
        cols = ['Richness_SUM_orig','Richness_STDEV_orig','Richness_COUNT_orig','S1_SUM_orig','S1_STDEV_orig','S1_COUNT_orig']
        ...
        df_normalized.columns = df_normalized.columns.str.replace('_orig','')
        ...
        #df = df[(df['s1_factor']/df['Richness_factor'])>0]
...
class similarityAnalysis():
    ...
    def classification(df_filtered):
        ...
        #y_predict,model_name  = ClusteringAnalysis.kmeans(x)
        #y_predict,model_name,score_of_determination  = ClusteringAnalysis.oneclassSVM_simple(x)
        #y_predict,model_name  = ClusteringAnalysis.spectral(x)

        #y_predict,model_name  = ClusteringAnalysis.birch(df_filtered)
        #y_predict,model_name  = ClusteringAnalysis.agglomerativeClustering(x)
        #y_predict,model_name  = ClusteringAnalysis.opticsClustering(x)
...
class ClusteringAnalysis():
    ...
    def oneclassSVM(x):
        ...
        x_shap = shap.sample(x_shap_orig,1000,random_state=2000)
...
class evaluation():
    def Visualize(x,df_similarity,y_predict):
        ...
        df_12 =df_similarity[(df_similarity['CodeC']==192) & (df_similarity['CodeB']==169) & (df_similarity['CodeA']==252)]
        df_13 =df_similarity[(df_similarity['CodeC']==192) & (df_similarity['CodeB']==56) & (df_similarity['CodeA']==173)]
        df_14 =df_similarity[(df_similarity['CodeC']==192) & (df_similarity['CodeB']==118) & (df_similarity['CodeA']==205)]
        df_15 =df_similarity[(df_similarity['CodeC']==140) & (df_similarity['CodeB']==197) & (df_similarity['CodeA']==14)]
        df_16 =df_similarity[(df_similarity['CodeC']==192) & (df_similarity['CodeB']==4) & (df_similarity['CodeA']==56)]
        df_17 =df_similarity[(df_similarity['CodeC']==192) & (df_similarity['CodeB']==42) & (df_similarity['CodeA']==166)]
        df_18 =df_similarity[(df_similarity['CodeC']==192) & (df_similarity['CodeB']==52) & (df_similarity['CodeA']==159)]
        ...
        for i in range(len(x_sample_1355)):
            if  (df_sample['CodeA'].values[i]==169 and df_sample['CodeB'].values[i]==247 and df_sample['CodeC'].values[i]==192)==True:
                plt.text(x_sample_1355[i]+0.2,y_sample_1355[i]-0.2,text_sample[i],fontsize='small')
            elif  (df_sample['CodeA'].values[i]==235 and df_sample['CodeB'].values[i]==245 and df_sample['CodeC'].values[i]==192)==True:
                plt.text(x_sample_1355[i]+0.2,y_sample_1355[i]-0.2,text_sample[i],fontsize='small')
            else:
        ...
        for i in range(len(x_sample_1361)):
            print(i,df_sample['CodeA'].values[i],df_sample['CodeB'].values[i],df_sample['CodeC'].values[i])
            if (df_sample['CodeA'].values[i]==134 and df_sample['CodeB'].values[i]==207 and df_sample['CodeC'].values[i]==192)==True:
                plt.text(x_sample_1361[i]-0.4,y_sample_1361[i]+0.2,text_sample[i],fontsize='small')
            elif  (df_sample['CodeA'].values[i]==191 and df_sample['CodeB'].values[i]==245 and df_sample['CodeC'].values[i]==192)==True:
                plt.text(x_sample_1361[i]-0.4,y_sample_1361[i]+0.2,text_sample[i],fontsize='small')
            elif (df_sample['CodeA'].values[i]==233 and df_sample['CodeB'].values[i]==137 and df_sample['CodeC'].values[i]==192)==True:
                plt.text(x_sample_1361[i]+0.4,y_sample_1361[i]-0.2,text_sample[i],fontsize='small',ha='left')
            else:
                print(i)
        ...
        plt.ylabel('PCA 2')
        for i in range(len(x_sample_1355)):
            if  (df_sample['CodeA'].values[i]==235 and df_sample['CodeB'].values[i]==245 and df_sample['CodeC'].values[i]==192)==True:
                plt.text(x_sample_1355[i]+0.2,y_sample_1355[i]-0.2,text_sample[i],fontsize='small')
            else:
                plt.text(x_sample_1355[i],y_sample_1355[i]+0.2,text_sample[i],fontsize='small')
        plt.legend(loc='best')
        ...
        plt.ylabel('PCA 2')
        for i in range(len(x_sample_1361)):
            if (df_sample['CodeA'].values[i]==52 and df_sample['CodeB'].values[i]==194 and df_sample['CodeC'].values[i]==192)==True:
                plt.text(x_sample_1361[i]-0.4,y_sample_1361[i],text_sample[i],fontsize='small',ha='right')
            elif (df_sample['CodeA'].values[i]==233 and df_sample['CodeB'].values[i]==137 and df_sample['CodeC'].values[i]==192)==True:
                plt.text(x_sample_1361[i]-0.6,y_sample_1361[i]-0.2,text_sample[i],fontsize='small',ha='right')
            elif (df_sample['CodeA'].values[i]==235 and df_sample['CodeB'].values[i]==245 and df_sample['CodeC'].values[i]==192)==True:
                plt.text(x_sample_1361[i],y_sample_1361[i]+0.4,text_sample[i],fontsize='small',ha='right')
            else:
        ...
        for i in range(len(x_sample)):
            if (df_sample['CodeA'].values[i]==134 and df_sample['CodeB'].values[i]==207 and df_sample['CodeC'].values[i]==192)==True:
                ax.text(x_sample[i]+0.2,y_sample[i]-0.2,z_sample[i]-0.2,text_sample[i],fontsize='x-small')
            else:
        ...
        for i in range(len(x_sample)):
            if (df_sample['CodeA'].values[i]==134 and df_sample['CodeB'].values[i]==207 and df_sample['CodeC'].values[i]==192)==True:
                ax.text(x_sample[i]+0.2,y_sample[i]-0.2,z_sample[i]-0.2,text_sample[i],fontsize='x-small')
            elif (df_sample['CodeA'].values[i]==252 and df_sample['CodeB'].values[i]==169 and df_sample['CodeC'].values[i]==192)==True:
                ax.text(x_sample[i]-0.2,y_sample[i]-0.4,z_sample[i]-0.2,text_sample[i],fontsize='x-small')
            else:
                ax.text(x_sample[i],y_sample[i]+0.2,z_sample[i],text_sample[i],fontsize='x-small')
        plt.legend(loc='best')
        fig_11=plt.gcf()
        ...
        ax.set_zlabel('PCA 3')
        for i in range(len(x_sample)):
            if (df_sample['CodeA'].values[i]==205 and df_sample['CodeB'].values[i]==118 and df_sample['CodeC'].values[i]==192)==True:
                ax.text(x_sample[i]+0.2,y_sample[i]+0.4,z_sample[i]+0.2,text_sample[i],fontsize='x-small',va='top')
            else:
                ax.text(x_sample[i],y_sample[i]+0.2,z_sample[i],text_sample[i],fontsize='x-small')
        plt.legend(loc='best')
        fig_12=plt.gcf()
        ...
        for i in range(len(x_sample)):
            if (df_sample['CodeA'].values[i]==205 and df_sample['CodeB'].values[i]==118 and df_sample['CodeC'].values[i]==192)==True:
                ax.text(x_sample[i]+0.2,y_sample[i]-0.2,z_sample[i]-0.2,text_sample[i],fontsize='x-small',ha='left',va='bottom')
            elif (df_sample['CodeA'].values[i]==134 and df_sample['CodeB'].values[i]==207 and df_sample['CodeC'].values[i]==192)==True:
                ax.text(x_sample[i]+0.2,y_sample[i]-0.2,z_sample[i]-0.2,text_sample[i],fontsize='x-small',ha='left',va='bottom')
            else:
                ax.text(x_sample[i],y_sample[i]+0.2,z_sample[i],text_sample[i],fontsize='x-small')
        plt.legend(loc='best')
        ...
        plt.savefig(graph_dir+png_name_roc)
        plt.close()  
        return fig_1,fig_2,fig_3,fig_4,fig_5,fig_6,fig_7,fig_8,fig_9,fig_10,fig_11,fig_12,fig_13
    ...
    def score(df_similarity):
        ...
        #df_similarity = pd.read_csv('/Users/xiaotan/Documents/chemistry_phase1/data/phase_1/result_kmeans_insr.csv')
        ...
        df_similarity_1['Similarity_point_RANK_pY1355_mixed']=df_similarity_1['Similarity_point_pY1355_mixed'].rank(ascending=False).astype(float)
        df_similarity_1['Similarity_point_RANK_pY1361_mixed']=df_similarity_1['Similarity_point_pY1361_mixed'].rank(ascending=False).astype(float)
        ...
        #df_similarity_1['Score']=(df_similarity_1['Similarity_RANK']/2+(df_similarity_1['Similarity_point_RANK_pY1355_mixed']+df_similarity_1['Similarity_point_RANK_pY1361_mixed'])/4+(df_similarity_1['Richness_COUNT_RANK']+df_similarity_1['Richness_SUM_RANK'])).astype(float)
        ...
        #df_similarity_1['Score']=(df_similarity_1['Similarity_centralLine_RANK_pY1355']+df_similarity_1['Similarity_centralLine_RANK_pY1361'])/4+df_similarity_1['Similarity_RANK']+(df_similarity_1['Richness_COUNT_RANK']+df_similarity_1['Richness_SUM_RANK'])
        ...
        df_similarity_1['Score']=(df_similarity_1['Similarity_centralLine_RANK_pY1355_mixed']+df_similarity_1['Similarity_centralLine_RANK_pY1361_mixed'])/2+df_similarity_1['Similarity_RANK']/2+(df_similarity_1['Richness_COUNT_RANK']+df_similarity_1['Richness_SUM_RANK'])
        #df_similarity_1['Score']=(df_similarity_1['Similarity_centralLine_RANK_pY1355_mixed']+df_similarity_1['Similarity_centralLine_RANK_pY1361_mixed'])/2+(df_similarity_1['Richness_COUNT_RANK']+df_similarity_1['Richness_SUM_RANK'])
        ...
        #df_similarity_1['Score']=df_similarity_1['Similarity_RANK']
        '''
        ...
        df_similarity_0['Similarity_point_RANK_pY1355']=df_similarity_0['Similarity_point_pY1355'].rank(ascending=False).astype(float)
        df_similarity_0['Similarity_point_RANK_pY1361']=df_similarity_0['Similarity_point_pY1361'].rank(ascending=False).astype(float)
        ...
        #df_similarity_0['Score']=df_similarity_0['Similarity_RANK']
        ...
        #df_similarity_0['Score']=(df_similarity_0['Similarity_RANK']+(df_similarity_0['Similarity_antiinsr_RANK_pY1355']+df_similarity_0['Similarity_antiinsr_RANK_pY1361'])/2+(df_similarity_0['Richness_COUNT_RANK']+df_similarity_0['Richness_SUM_RANK'])).astype(float)
        ...
        #df_similarity_0['Score']=(df_similarity_0['Similarity_RANK']+(df_similarity_0['Similarity_point_RANK_pY1355_mixed']+df_similarity_0['Similarity_point_RANK_pY1361_mixed'])+(df_similarity_0['Richness_COUNT_RANK']+df_similarity_0['Richness_SUM_RANK'])).astype(float)
        ...
        #df_similarity_0['Score']=df_similarity_0['Similarity_RANK']/2+(df_similarity_0['Richness_COUNT_RANK']+df_similarity_0['Richness_SUM_RANK'])+(df_similarity_0['S1_COUNT_RANK']+df_similarity_0['S1_SUM_RANK'])
        #df_similarity_0['Score']=df_similarity_0['Similarity_RANK']/2+(df_similarity_0['Similarity_point_RANK_pY1355_mixed']+df_similarity_0['Similarity_point_RANK_pY1361_mixed'])/2+(df_similarity_0['Richness_COUNT_RANK']+df_similarity_0['Richness_SUM_RANK'])/2
        ...
        #df_similarity_0['Score']=(df_similarity_0['Similarity_centralLine_RANK_pY1355_mixed']+df_similarity_0['Similarity_centralLine_RANK_pY1361_mixed'])/2+(df_similarity_0['Richness_COUNT_RANK']+df_similarity_0['Richness_SUM_RANK'])              
        '''
...
if __name__=='__main__':
    data_dir = 'C:/Users/sharo/Documents/chemistry/chemistry_phase1/chemistry_phase1/output/phase_1/level_0/output_OneClassSVM_level1_orig.csv'
    temp_dir = 'C:/Users/sharo/Documents/chemistry/chemistry_phase1/chemistry_phase1/parameters/phase_1/level_1/'
    insr_dir = 'C:/Users/sharo/Documents/chemistry/chemistry_phase1/chemistry_phase1/data/preprocessed/phase_1/data_group_filtered_updated.csv'
    erh_dir = 'C:/Users/sharo/Documents/chemistry/chemistry_phase1/chemistry_phase1/data/phase_1/erh/'
    graph_dir='C:/Users/sharo/Documents/chemistry/chemistry_phase1/chemistry_phase1/graph/phase_1/level_1/'
    output_dir='C:/Users/sharo/Documents/chemistry/chemistry_phase1/chemistry_phase1/output/phase_1/level_1/'
    #gc.collect()
    ...
    #df_insr.to_csv('C:/Users/sharo/Documents/chemistry_phase1/data/phase_2/result_insr.csv',chunksize=10000)
    #df_insr = pd.read_csv('C:/Users/sharo/Documents/chemistry_phase1/data/phase_2/result_insr.csv')
    ...
    #df_filtered = outlierFiltering(x_bind_2,df_filtered,4)
    ...
    fig_1,fig_2,fig_3,fig_4,fig_5,fig_6,fig_7,fig_8,fig_9,fig_10,fig_11,fig_12,fig_13 = evaluation.Visualize(x,df_similarity,y_predict)
